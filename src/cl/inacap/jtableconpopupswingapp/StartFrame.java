...
public class StartFrame extends JFrame {
	...
	public void popUpTable() {
		...
		mi.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) { //Aca va el código que se ejecuta cuando se selecciona este JMenuItem (Acá se podría tomar los datos de la celda seleccinada y realizar una acción).
				JOptionPane.showMessageDialog(null, "Seleccionaste el mensaje");	
			}
		});
		pm.add(mi); //Aca se le añade el JMenuItem al PopUp.
		table.setComponentPopupMenu(pm); //Aca se le añade el PopUp al JTable.
	}
}
